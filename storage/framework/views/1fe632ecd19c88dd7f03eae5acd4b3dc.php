...
<html lang="en">
    ...
    <body>
        ...
        <!-- Back to Top -->
        <a href="<?php echo e(url('product_category', $categorys->id)); ?>" class="btn btn-primary border-3 border-primary rounded-circle back-to-top"><i class="fa fa-arrow-up"></i></a>   

        <?php echo $__env->make('home.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </body>
</html><?php /**PATH D:\labs\Павленко Владислав\Mediaplex\resources\views/home/product_category.blade.php ENDPATH**/ ?>